...
<c:choose>
  <c:when test="${articlesList ==null }" >
    <tr  height="10">
      <td colspan="4">
         <p align="center">
            <b><span style="font-size:9pt;">No story</span></b>
        </p>
      </td>  
    </tr>
  </c:when>
...
<!-- <a  class="cls1"  href="#"><p class="cls2">ê¸ì°ê¸°</p></a> --> 
<center>
<a    href="javascript:fn_articleForm('../boardWriteForm')"><p class="btn btn-info">write</p></a>
</center>
</body>
</html>
